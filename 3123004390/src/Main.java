...
public class Main {
     ...
     * 读取文件内容并尝试检测编码
     */
    public static String readFileWithEncodingDetection(String filePath) throws IOException {
        // 尝试常见编码读取文件
     ...
     * 计算文本的SimHash值
     */
    public static long calculateSimHash(String text) {
        // 处理空文本情况
     ...
     * 计算单个词的哈希值
     */
    public static long calculateWordHash(String word) {
     ...
     */
    public static void writeResult(String resultFilePath, int hammingDistance,
    ...
    public static void runTestCases() {
        ...
        String[][] testCases = {
                // 正常测试用例
                {"D:/桌面/3123004390/test_word/test1_orig.txt", "D:/桌面/3123004390/test_word/test1_yuanwen.txt", "D:/桌面/3123004390/test_word/result.txt"},
                {"D:/桌面/3123004390/test_word/test2_orig.txt", "D:/桌面/3123004390/test_word/test2_xiugai.txt", "D:/桌面/3123004390/test_word/result.txt"},
                {"D:/桌面/3123004390/test_word/test3_orig.txt", "D:/桌面/3123004390/test_word/test3_yuxu.txt", "D:/桌面/3123004390/test_word/result.txt"},
                {"D:/桌面/3123004390/test_word/test4_orig.txt", "D:/桌面/3123004390/test_word/test4_kongbai.txt", "D:/桌面/3123004390/test_word/result.txt"},
                {"D:/桌面/3123004390/test_word/orig.txt", "D:/桌面/3123004390/test_word/orig_0.8_add.txt", "D:/桌面/3123004390/test_word/result.txt"},
                {"D:/桌面/3123004390/test_word/orig.txt", "D:/桌面/3123004390/test_word/orig_0.8_del.txt", "D:/桌面/3123004390/test_word/result.txt"},
